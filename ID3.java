...
/****** Getting Given attribute values ****/
...
/*** Identifying previously Decomposed Nodes ***/
...
/********* partitioning The Parent Nodes(gains) *******/
...
/**** Read Input Data from external text File ******/
...
/* Print decision tree based on input data*/ 
...
public void printTree(TreeNode node, String tab) throws Exception {
    ...
    for (int i=0; i < numvalues; i++) {
    System.out.println(" if( " + attributeNames[node.decompositionAttribute] + " == \"" + domains[node.decompositionAttribute].elementAt(i) + "\") {" );
...
/* Initiation of main method*/ 
/****************************/
 public static void main(String[] args) throws Exception {
    ID3 id3 = new ID3();
    int status = id3.readData("C:/Users/Haftish/Desktop/Assignment/car.txt");
